...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-blue-100 text-blue-700 hover:bg-blue-200 focus:ring-blue-500 active:bg-blue-300",
    outline: "border-2 border-blue-600 text-blue-600 hover:bg-blue-50 focus:ring-blue-500 active:bg-blue-100",
    text: "text-blue-600 hover:bg-blue-50 focus:ring-blue-500 active:bg-blue-100",
  };
